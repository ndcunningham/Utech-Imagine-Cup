...
<head id="Head1" runat="server">
    <title>Checkout Wizard Complete</title>
</head>
<body>
    ...
    <div>
        ...
        <br />
        <asp:Wizard ID="wizCheckout" runat="server" ActiveStepIndex="3" 
            DisplayCancelButton="True" Width="739px" >
            <WizardSteps>
                ...
                <asp:WizardStep ID="WizardStep4" runat="server"
                    StepType="Complete" Title="Step 4: Complete">
                    Congratulations. You have completed the Checkout wizard.&nbsp;<br /><br />
                    Here is the data you entered:&nbsp;<br /><br />
                    <asp:TextBox ID="txtMessage" runat="server" Height="166px" 
                        TextMode="MultiLine" Width="489px"></asp:TextBox>
                </asp:WizardStep>
            </WizardSteps>
        </asp:Wizard>
    </div>
