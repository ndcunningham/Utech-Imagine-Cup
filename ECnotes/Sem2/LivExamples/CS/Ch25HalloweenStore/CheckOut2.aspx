...
<body>
    ...
    <div>
            ...
            <tr>
                <td style="width: 175px" rowspan="2" valign="top">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                        ...
                        Display="None" ErrorMessage="You must select a credit card." 
                        InitialValue="None">*</asp:RequiredFieldValidator>
                </td>
                <td align="right" style="width: 100px" valign="top">Number:</td>
                <td style="width: 180px" valign="top">
                    <asp:TextBox ID="txtCardNumber" runat="server" MaxLength="20"
                ...
                <td style="width: 160px" rowspan="2" valign="top">
                    <asp:ValidationSummary ID="ValidationSummary1" runat="server"
                        HeaderText="Please correct the following errors:" Width="225px" />
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 100px" valign="top">Expiration date:</td>
                <td style="width: 180px" valign="top">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
            ...
            InsertCommand="INSERT INTO Invoices
                               (CustEMail, OrderDate, Subtotal, ShipMethod, Shipping,
                                SalesTax, Total, CreditCardType, CardNumber, 
                                ExpirationMonth, ExpirationYear) 
                           VALUES (@CustEMail, @OrderDate, @Subtotal, @ShipMethod, 
                                   @Shipping, @SalesTax, @Total, @CreditCardType, 
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server"
            ConnectionString="<%$ ConnectionStrings:HalloweenConnectionString %>"
            InsertCommand="INSERT INTO LineItems
