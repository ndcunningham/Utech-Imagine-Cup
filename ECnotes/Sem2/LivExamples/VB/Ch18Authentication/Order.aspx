...
<body>
    ...
    <div>
        ...
        <asp:LoginView ID="LoginView1" runat="server">
            <LoggedInTemplate>
                <asp:LoginName ID="LoginName1" runat="server" BorderWidth="0px" FormatString="You are logged in."
                    Width="363px" />
                <br />
                <asp:LoginStatus ID="LoginStatus2" runat="server" />
            </LoggedInTemplate>
            <AnonymousTemplate>
                <asp:Label ID="Label1" runat="server" BorderWidth="0px" Text="You are not logged in."
