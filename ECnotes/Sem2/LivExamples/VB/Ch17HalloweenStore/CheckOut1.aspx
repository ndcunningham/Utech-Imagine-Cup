        ...
        &nbsp;<table>
            <tr>
                <td style="width: 100px">
                    Email:</td>
                <td style="width: 100px">
                    <asp:TextBox ID="txtEmail" runat="server" Width="150px" MaxLength="25"></asp:TextBox></td>
                <td style="width: 176px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEmail"
                        ErrorMessage="Email is a required field."></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 100px">
                    First name:</td>
                <td style="width: 100px">
                    <asp:TextBox ID="txtFirstName" runat="server" Width="150px" MaxLength="20"></asp:TextBox></td>
                <td style="width: 176px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtFirstName"
                        ErrorMessage="First name is a required field."></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 100px">
                    Last name:</td>
                <td style="width: 100px">
                    <asp:TextBox ID="txtLastName" runat="server" Width="150px" MaxLength="20"></asp:TextBox></td>
                <td style="width: 176px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtLastName"
                        ErrorMessage="Last name is a required field."></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 100px">
                    Address:</td>
                <td style="width: 100px">
                    <asp:TextBox ID="txtAddress" runat="server" Width="250px" MaxLength="40"></asp:TextBox></td>
                <td style="width: 176px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAddress"
                        ErrorMessage="Address is a required field."></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 100px">
                    City:</td>
                <td style="width: 100px">
                    <asp:TextBox ID="txtCity" runat="server" Width="180px" MaxLength="30"></asp:TextBox></td>
                <td style="width: 176px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtCity"
                        ErrorMessage="City is a required field."></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 100px">
                    State:</td>
                <td style="width: 100px">
                    <asp:TextBox ID="txtState" runat="server" Width="25px" MaxLength="2"></asp:TextBox></td>
                <td style="width: 176px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtState"
                        ErrorMessage="State is a required field."></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 100px">
                    Zip code:</td>
                <td style="width: 100px">
                    <asp:TextBox ID="txtZipCode" runat="server" Width="75px" MaxLength="9"></asp:TextBox></td>
                <td style="width: 176px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtZipCode"
                        ErrorMessage="Zip code is a required field."></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 100px">
                    Phone:</td>
                <td style="width: 100px">
                    <asp:TextBox ID="txtPhone" runat="server" Width="150px" MaxLength="20"></asp:TextBox></td>
                <td style="width: 176px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtPhone"
                        Display="Dynamic" ErrorMessage="Phone is a required field."></asp:RequiredFieldValidator></td>
            </tr>
        </table>
